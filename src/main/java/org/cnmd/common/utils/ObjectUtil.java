...
//	*/
	 ...
	 */
	public static Map<String, Object> getFieldMap(BasicPO obj) {
	 ...
	 * 获取对象的字段映射（字段名 => 字段值）
	 */
	public static Map<String, Object> getFieldMap(BasicPO obj, boolean isStaticIgnored) {
